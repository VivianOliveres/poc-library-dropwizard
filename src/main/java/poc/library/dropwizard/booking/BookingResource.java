...
public class BookingResource {
    ...
    public Response getAllBookingsForUser(@PathParam("id") @NotNull long userId,
        ...
        logger.info("getAllBookingsForUser(userId[{}], isActive[{}]): service returned => {}", userId, isActive,
                maybeBooking);
        return maybeBooking.map(booking -> Response.ok(booking).build())
    ...
    @POST
    @Path("/{userId}/{bookId}")
    public Response insertBooking(@PathParam("userId") @NotNull long userId,
            @PathParam("bookId") @NotNull UUID bookId) {
    ...
    public Response updateBooking(@PathParam("userId") @NotNull long userId,
            @PathParam("bookId") @NotNull UUID bookId) {
